...
export function RegisterRoutes(app: express.Router) {
    ...
    // ###########################################################################################################
        app.post('/students',
            ...
            ...(fetchMiddlewares<RequestHandler>(StudentsController.prototype.createStudent)),

            function StudentsController_createStudent(request: any, response: any, next: any) {
            const args = {
                    requestBody: {"in":"body","name":"requestBody","required":true,"ref":"ICreateStudent"},
            };
        ...
        app.get('/students',
            ...
            function StudentsController_getStudents(request: any, response: any, next: any) {
            const args = {
            };
        ...
        app.get('/students/:studentId',
            ...(fetchMiddlewares<RequestHandler>(StudentsController)),
            ...(fetchMiddlewares<RequestHandler>(StudentsController.prototype.getStudentById)),

            function StudentsController_getStudentById(request: any, response: any, next: any) {
            const args = {
                    studentId: {"in":"path","name":"studentId","required":true,"dataType":"double"},
            };
        ...
        app.patch('/students/:studentId',
            ...
            function StudentsController_updateStudent(request: any, response: any, next: any) {
            const args = {
                    studentId: {"in":"path","name":"studentId","required":true,"dataType":"double"},
                    requestBody: {"in":"body","name":"requestBody","required":true,"ref":"ICreateStudent"},
            };
        ...
        app.delete('/students/:studentId',
            ...
            function StudentsController_deleteStudent(request: any, response: any, next: any) {
            const args = {
                    studentId: {"in":"path","name":"studentId","required":true,"dataType":"double"},
            };
